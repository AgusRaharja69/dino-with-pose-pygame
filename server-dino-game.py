...
ground_x = 0  # Declare ground_x globally
...
# Main Game Loop
def game_loop(conn):
    global game_speed, player_score, game_over, obstacle_timer, obstacle_spawn, ground_x  # Declare ground_x as global

    while True:
        # Receive jump command from pose estimation client
        try:
        ...
        if not game_over:
            ...
            ground_x -= game_speed  # Now ground_x is accessible
